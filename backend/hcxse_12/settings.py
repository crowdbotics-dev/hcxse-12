"""
Django settings for hcxse_12 project.
...
WSGI_APPLICATION = 'hcxse_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hcxse_12 API",
    "DESCRIPTION": "API documentation for hcxse_12 App",
    "VERSION": "v1",
}
